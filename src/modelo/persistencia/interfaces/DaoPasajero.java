...
public interface DaoPasajero {
	...
	/**
	 * Método para consultar un pasajero en la BBDD. 
	...
	/**
	 * Método para listar todos los pasajeros de la BBDD. 
	 * @return la lista de pasajeros de la BBDD o mensaje de error en caso de error
	 * con la BBDD.
	 */
	public List<Pasajero> listarPasajeros();
	/**
	 * Método que añade un pasajero a un coche en la BBDD. Se generará el ID de manera
	 * automática.
	...
	/**
	 * Método que borra un pasajero de un coche en la BBDD. 
	...
	/**
	 * Método para listar todos los pasajeros de un coche de la BBDD. 
